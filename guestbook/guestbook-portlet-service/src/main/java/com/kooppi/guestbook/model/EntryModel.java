...
/**
 * The base model interface for the Entry service. Represents a row in the &quot;rm_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.kooppi.guestbook.model.impl.EntryModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.kooppi.guestbook.model.impl.EntryImpl}.
 * </p>
 *
...
public interface EntryModel extends BaseModel<Entry>, StagedGroupedModel,
    ...
    @Override
    public CacheModel<com.kooppi.guestbook.model.Entry> toCacheModel();
