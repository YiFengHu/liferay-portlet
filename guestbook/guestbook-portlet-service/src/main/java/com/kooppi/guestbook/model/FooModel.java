...
/**
 * The base model interface for the Foo service. Represents a row in the &quot;guestbook_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.kooppi.guestbook.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.kooppi.guestbook.model.impl.FooImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see Foo
 * @see com.kooppi.guestbook.model.impl.FooImpl
 * @see com.kooppi.guestbook.model.impl.FooModelImpl
 * @generated
 */
public interface FooModel extends BaseModel<Foo>, StagedGroupedModel {
    ...
    @Override
    public CacheModel<com.kooppi.guestbook.model.Foo> toCacheModel();
