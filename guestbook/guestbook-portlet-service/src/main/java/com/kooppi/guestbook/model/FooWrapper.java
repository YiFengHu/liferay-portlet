...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(com.kooppi.guestbook.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.kooppi.guestbook.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public com.kooppi.guestbook.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public com.kooppi.guestbook.model.Foo toUnescapedModel() {
