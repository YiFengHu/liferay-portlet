...
public class GuestbookWrapper implements Guestbook, ModelWrapper<Guestbook> {
    ...
    */
    ...
    @Override
    public int compareTo(com.kooppi.guestbook.model.Guestbook guestbook) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.kooppi.guestbook.model.Guestbook> toCacheModel() {
        return _guestbook.toCacheModel();
    }

    @Override
    public com.kooppi.guestbook.model.Guestbook toEscapedModel() {
        return new GuestbookWrapper(_guestbook.toEscapedModel());
    }

    @Override
    public com.kooppi.guestbook.model.Guestbook toUnescapedModel() {
