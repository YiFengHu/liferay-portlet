...
public interface EntryLocalService extends BaseLocalService,
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link EntryLocalServiceUtil} to access the entry local service. Add custom service methods to {@link com.kooppi.guestbook.service.impl.EntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
    ...
    */
    ...
    public com.kooppi.guestbook.model.Entry addEntry(
    ...
    */
    public com.kooppi.guestbook.model.Entry createEntry(long entryId);
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.DELETE)
    public com.kooppi.guestbook.model.Entry deleteEntry(
        com.kooppi.guestbook.model.Entry entry)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    ...
    public com.kooppi.guestbook.model.Entry fetchEntry(long entryId)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kooppi.guestbook.model.Entry fetchEntryByUuidAndCompanyId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kooppi.guestbook.model.Entry fetchEntryByUuidAndGroupId(
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kooppi.guestbook.model.Entry getEntry(long entryId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kooppi.guestbook.model.Entry getEntryByUuidAndCompanyId(
        java.lang.String uuid, long companyId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public com.kooppi.guestbook.model.Entry getEntryByUuidAndGroupId(
        java.lang.String uuid, long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException;
    ...
    */
    @com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
    public com.kooppi.guestbook.model.Entry updateEntry(
        com.kooppi.guestbook.model.Entry entry)
        throws com.liferay.portal.kernel.exception.SystemException;
