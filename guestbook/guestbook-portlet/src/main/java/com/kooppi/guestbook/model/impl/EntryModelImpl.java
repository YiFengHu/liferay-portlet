...
import com.kooppi.guestbook.model.EntryModel;
import com.kooppi.guestbook.model.EntrySoap;
...
/**
 * The base model implementation for the Entry service. Represents a row in the &quot;rm_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.kooppi.guestbook.model.EntryModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link EntryImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see EntryImpl
 * @see com.kooppi.guestbook.model.Entry
 * @see com.kooppi.guestbook.model.EntryModel
 * @generated
 */
@JSON(strict = true)
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a entry model instance should use the {@link com.kooppi.guestbook.model.Entry} interface instead.
     */
    public static final String TABLE_NAME = "rm_Entry";
    public static final Object[][] TABLE_COLUMNS = {
            ...
            { "name", Types.VARCHAR },
            { "conferenceRoomName", Types.VARCHAR },
            { "useDate", Types.VARCHAR },
            { "guestbookId", Types.BIGINT },
            { "status", Types.INTEGER },
            { "statusByUserId", Types.BIGINT },
            { "statusByUserName", Types.VARCHAR },
            { "statusDate", Types.TIMESTAMP },
            { "statusTaskAssigneeId", Types.BIGINT }
        };
    public static final String TABLE_SQL_CREATE = "create table rm_Entry (uuid_ VARCHAR(75) null,entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,message VARCHAR(75) null,name VARCHAR(75) null,conferenceRoomName VARCHAR(75) null,useDate VARCHAR(75) null,guestbookId LONG,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null,statusTaskAssigneeId LONG)";
    public static final String TABLE_SQL_DROP = "drop table rm_Entry";
    public static final String ORDER_BY_JPQL = " ORDER BY entry.entryId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY rm_Entry.entryId ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.kooppi.guestbook.model.Entry"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.kooppi.guestbook.model.Entry"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.kooppi.guestbook.model.Entry"),
            true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.kooppi.guestbook.model.Entry"));
    ...
    public static Entry toModel(EntrySoap soapModel) {
        ...
        model.setConferenceRoomName(soapModel.getConferenceRoomName());
        ...
        model.setStatusTaskAssigneeId(soapModel.getStatusTaskAssigneeId());
    ...
    public Object clone() {
        ...
        entryImpl.setConferenceRoomName(getConferenceRoomName());
        entryImpl.setUseDate(getUseDate());
        ...
        entryImpl.setStatusTaskAssigneeId(getStatusTaskAssigneeId());
    ...
    public CacheModel<Entry> toCacheModel() {
        ...
        entryCacheModel.conferenceRoomName = getConferenceRoomName();

        String conferenceRoomName = entryCacheModel.conferenceRoomName;

        if ((conferenceRoomName != null) && (conferenceRoomName.length() == 0)) {
            entryCacheModel.conferenceRoomName = null;
        }

        entryCacheModel.useDate = getUseDate();

        String useDate = entryCacheModel.useDate;

        if ((useDate != null) && (useDate.length() == 0)) {
            entryCacheModel.useDate = null;
        }
        ...
        entryCacheModel.statusTaskAssigneeId = getStatusTaskAssigneeId();
