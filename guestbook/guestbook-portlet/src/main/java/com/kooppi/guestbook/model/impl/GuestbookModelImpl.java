...
import com.kooppi.guestbook.model.GuestbookModel;
import com.kooppi.guestbook.model.GuestbookSoap;
...
/**
 * The base model implementation for the Guestbook service. Represents a row in the &quot;rm_Guestbook&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.kooppi.guestbook.model.GuestbookModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link GuestbookImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see GuestbookImpl
 * @see com.kooppi.guestbook.model.Guestbook
 * @see com.kooppi.guestbook.model.GuestbookModel
 * @generated
 */
@JSON(strict = true)
public class GuestbookModelImpl extends BaseModelImpl<Guestbook>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a guestbook model instance should use the {@link com.kooppi.guestbook.model.Guestbook} interface instead.
     */
    public static final String TABLE_NAME = "rm_Guestbook";
    ...
    public static final String TABLE_SQL_CREATE = "create table rm_Guestbook (uuid_ VARCHAR(75) null,guestbookId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null)";
    public static final String TABLE_SQL_DROP = "drop table rm_Guestbook";
    public static final String ORDER_BY_JPQL = " ORDER BY guestbook.guestbookId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY rm_Guestbook.guestbookId ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.kooppi.guestbook.model.Guestbook"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.kooppi.guestbook.model.Guestbook"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.kooppi.guestbook.model.Guestbook"),
            true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.kooppi.guestbook.model.Guestbook"));
