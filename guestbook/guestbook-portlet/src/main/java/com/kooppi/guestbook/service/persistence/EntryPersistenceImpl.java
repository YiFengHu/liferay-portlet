...
import com.kooppi.guestbook.NoSuchEntryException;
import com.kooppi.guestbook.model.Entry;
import com.kooppi.guestbook.model.impl.EntryImpl;
import com.kooppi.guestbook.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
    ...
    @Override
    public Entry updateImpl(com.kooppi.guestbook.model.Entry entry)
        throws SystemException {
        entry = toUnwrappedModel(entry);
    ...
    protected Entry toUnwrappedModel(Entry entry) {
        ...
        entryImpl.setConferenceRoomName(entry.getConferenceRoomName());
        entryImpl.setUseDate(entry.getUseDate());
        ...
        entryImpl.setStatusTaskAssigneeId(entry.getStatusTaskAssigneeId());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.kooppi.guestbook.model.Entry")));
