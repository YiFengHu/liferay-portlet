...
import com.kooppi.guestbook.NoSuchFooException;
import com.kooppi.guestbook.model.Foo;
import com.kooppi.guestbook.model.impl.FooImpl;
import com.kooppi.guestbook.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
    ...
    @Override
    public Foo updateImpl(com.kooppi.guestbook.model.Foo foo)
        throws SystemException {
        foo = toUnwrappedModel(foo);
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.kooppi.guestbook.model.Foo")));
